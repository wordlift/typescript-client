 ...
 */
export function instanceOfPageOAuth2AuthorizedClient(value: object): boolean {
    let isInstance = true;
...
export function PageOAuth2AuthorizedClientToJSON(value?: PageOAuth2AuthorizedClient | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
